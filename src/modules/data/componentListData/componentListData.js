export const componentListData = [
    {
        ...
        description: `Simple yet flexible charting Lightning Web Component using Chart.js for admins & developers`,
    ...
    },
    {
        ...
        repo: 'https://github.com/tsalb/lwc-utils',
        description: `Reusable LWCs to 10x your solution building speed. Design interactive, data-dense UIs with LWC + Screen Flows.`,
    ...
    {
        title: 'LWC Redux',
        repo: 'https://github.com/chandrakiran-dev/lwc-redux',
        description:
    ...
    },
    {
        ...
        repo: 'https://github.com/shunkosa/lightning-chatter-messenger',
        description: `An utility item to support real time private chatter conversations.`,
    ...
    {
        title: 'LWC Modal',
        repo: 'https://github.com/jamessimone/lwc-modal',
        description:
    ...
    },
    {
        ...
        description: `A custom path assistant built using only Lightning Web Components`,
    ...
    },
    {
        ...
        repo:
            'https://github.com/lucianostraga/userInteractions-platformEvents-lwc',
        description:
    ...
    },
    {
        ...
        repo: 'https://github.com/pozil/sfdc-ui-lookup-lwc',
        description:
    ...
    },
    {
        ...
        repo: 'https://github.com/SFXD/LWC-Lookup-Datatable',
        description:
    ...
    {
        title: 'One PubSub',
        repo: 'https://github.com/TheVishnuKumar/one-pub-sub-lwc',
        description:
    ...
    },
    {
        ...
        repo: 'https://github.com/samkhan27/lwc-signature-pad',
        description:
    ...
    {
        title: 'Polyglot',
        repo: 'https://github.com/ruslan-kurchenko/lwc-polyglot',
        description:
    ...
    },
    {
        ...
        repo: 'https://github.com/surajp/lwc-files-list',
        description:
    ...
    },
    {
        ...
        repo: 'https://github.com/arufian/LWC-Component-COVID19',
        description:
    ...
    {
        title: 'Payment Form',
        repo: 'https://github.com/rapsacnz/PaymentForm',
        description:
    ...
    },
    {
        ...
        repo: 'https://github.com/victorgz/sfdc-apex-continuations',
        description:
    ...
    {
        title: 'Tilewall',
        repo: 'https://github.com/Dogeforce/tilewall-lwc',
        description:
    ...
    {
        title: 'LWC Action',
        repo: 'https://github.com/andrii-solokh/LWCAction',
        description:
